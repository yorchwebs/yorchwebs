...
- Me encuentro aprendiendo y desarrollando proyectos en **Python** :snake: y su Framework **Flask**, **Flask Restful** (API REST), Bases de Datos Relacionales **MySQL**, y No Relacionales **MongoDB**, preparándome para certificarme en **Microsoft Azure** :cloud:
